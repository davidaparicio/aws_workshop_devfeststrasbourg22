...
func NewPipelineStack(scope constructs.Construct, id string, props *PipelineStackProps) awscdk.Stack {
	...
	//any good CD pipeline is source control. Here we will create a CodeCommit repository to contain our project code.
	...
	//npx cdk deploy
	//Once deployment is finished, you can go to the CodePipeline console and you will see a new pipeline!
	return stack
}
